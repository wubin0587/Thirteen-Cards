...
CKPT_PATH = os.path.join(_SCRIPT_DIR, "models", "thirteen_cards_ranker.pt")
...
class TestInputUtils(unittest.TestCase):
    ...
    def test_card_rank_single_deck(self):
        ...
        self.assertEqual(card_rank(4),  1)   # 3♦ → rank 1
        self.assertEqual(card_rank(48), 12)  # A♦ → rank 12
...
class TestInputCpp(unittest.TestCase):
    ...
    def test_search_pattern_tail_straight_flush(self):
        from input import py_search_pattern
        # A♦ K♦ Q♦ J♦ 10♦ → 尾墩同花顺
        result = py_search_pattern(2, [48, 44, 40, 36, 32])
